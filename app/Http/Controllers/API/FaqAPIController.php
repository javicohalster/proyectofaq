...
class FaqAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        foreach ($faqs as  $key=>$value) {
            $faqs[$key]['category'] = $value->category;
            //dd($value->category);
            //$faqs[$key]['category'] = $this->faqCategoryRepository->findWithoutFail($value->faqcategory_id);
        }
    ...
    public function show($id)
    {
        ...
        $faq['category'] = $this->faqRepository->getFaqCategory($id);
